...
app.get("/", function (req, res) {
    ...
    CurrentPage = "/static/html/main.html"
})


app.get("/register", function (req, res) {
    res.sendFile(path.join(__dirname + "/static/html/register.html"))
    CurrentPage = "/static/html/register.html"
...
app.get("/admin", function (req, res) {
    ...
    if (Check == true) {
        res.sendFile(path.join(__dirname + "/static/html/admin_access.html"))

    }
    else {
        res.status(403).sendFile(path.join(__dirname + "/static/html/admin_noaccess.html"))
        CurrentPage = "/static/html/admin_noaccess.html"
    }
})
...
app.get("/login", function (req, res) {
    ...
    CurrentPage = "/static/html/login.html"
